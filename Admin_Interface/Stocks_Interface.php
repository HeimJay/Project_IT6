...
<body>
    <div class="full-page-div">
        ...
        <div class="../Images/add"><a href="#" class="btn btn-danger rounded-pill mx-auto d-flex align-items-center justify-content-center mt-0" style="width: 100%; height: 50px;">
...
<body>
    <div class="full-page-div">
        <div class="side-page-div">
            ...
            <!--Sign-Out-->
            <a href="../Logins/User.php" class="btn btn-dark rounded-pill mx-auto d-flex align-items-center justify-content-center mt-5" style="width: 65%; height: 42px;">
                <img src="../Images/logout.png" class="p-1" style="width: 20%; height: auto" alt="logout.png">Sign Out</a>
        </div>
        <div class="main-content-div mt-3">
            <div class="dashboard-header">
                <img src="../Images/ready-stock.png" class="p-1" style="width: 12%; height: auto" alt="dashboard.png">
...
>>>>>>> 8b29a6bff81bef1f084beee24e37b85e74a5286f
</html>