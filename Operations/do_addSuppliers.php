...
<head>
    ...
    <title>Admin Dashboard | Add Suppliers</title>
    ...
    <div class="d-flex">
        ...
        <div class="container-fluid p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><img src="../Images/wholesale.png" width="40"> Add Supplier</h1>
            </div>
                ...
                <div class="card-body">
                    <form action="../Database_Operations/execute_Suppliers.php" method="POST">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" name="addBTN" class="btn btn-danger">Save</button>
                        </div>
                    </form>
                </div>
            </div>
