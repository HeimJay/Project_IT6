    ...
    <div class="d-flex">
        ...
        <div class="container-fluid p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><img src="../Images/ready-stock.png" width="40"> Edit Stock</h1>
            </div>

            <div class="card border-danger">
                <div class="card-header bg-danger text-white text-center">
                    <h5>EDIT: <?php echo $row['item_name'] ?></h5>
                </div>
                <div class="card-body">
                    <form action="../Database_Operations/execute_stock.php" method="post">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="iname" id="iname" readonly class="form-control" value="<?php echo $row['item_name'] ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="sQty" class="form-label"><h4>In Stock:</h4></label>
                                <input type="text" name="sQty" id="sQty" class="form-control" value="<?php echo $row['stock_quantity'] ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="srPrice" class="form-label"><h4>SR Price:</h4></label>
                                <input type="text" name="srPrice" id="srPrice" class="form-control" value="<?php echo $row['price'] ?>">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-danger" name="editStockBTN">Save</button>
