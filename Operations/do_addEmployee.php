    ...
    <div class="d-flex">
        ...
        <div class="container-fluid p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><img src="../Images/list-items.png" width="40"> Add Employee</h1>
            </div>
                    ...
                    <form action="../Database_Operations/execute_employees.php" method="post">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="password" name="ePass" id="ePass" class="form-control" required>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between">
                            <a href="../Admin_Interface/ItemList_Interface.php" class="btn btn-dark">Cancel</a>
                            <button type="submit" name="addEmpBTN" class="btn btn-danger">Add</button>
                        </div>
                    </form>
                </div>
            </div>
